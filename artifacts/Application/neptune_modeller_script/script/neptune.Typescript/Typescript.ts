(function () {
    ...
    import { Graph, Edge, Shape } from 'https://cdn.jsdelivr.net/npm/@antv/x6@2.13.1/+esm';
    ...
    import { Stencil } from 'https://cdn.jsdelivr.net/npm/@antv/x6-plugin-stencil/+esm';
    ...
    export function getX6Objects() {
        return new Promise((resolve, reject) => {
            (function check() {
                ...
                //@ts-ignore
                if (typeof Shape === 'undefined') return setTimeout(check, 10);
                //@ts-ignore
                ...
                //@ts-ignore
                if (typeof Stencil === 'undefined') return setTimeout(check, 10);
                //@ts-ignore
                resolve({ Graph, MiniMap, History, Scroller, Edge, Stencil, Shape });
            })();
        });
    }
}
